...
const datosJornadas = {
  ...
  3: [
    ...
    { fecha: "Viernes, 07/08/2026 - 20:15", local: "Cheo Madera", badgeLocal: "CM", visitante: "Team Bichota", badgeVisitante: "TB", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 08/08/2026 - 19:00", local: "Team Sufrido", badgeLocal: "TS", visitante: "A.Q.P", badgeVisitante: "AQE", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 08/08/2026 - 20:15", local: "Team Azua", badgeLocal: "LS", visitante: "Marqués de Vadillo", badgeVisitante: "MV", marcador: "-- - --", cancha: "Cancha Principal" }
  ],
  4: [
    { fecha: "Viernes, 14/08/2026 - 19:00", local: "Team Bichota", badgeLocal: "TB", visitante: "Team Sufrido", badgeVisitante: "TS", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Viernes, 14/08/2026 - 20:15", local: "Vieja Guardia", badgeLocal: "VG", visitante: "Team Azua", badgeVisitante: "LS", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 15/08/2026 - 19:00", local: "A.Q.P", badgeLocal: "AQE", visitante: "Team Abrante", badgeVisitante: "TA", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 15/08/2026 - 20:15", local: "Marqués de Vadillo", badgeLocal: "MV", visitante: "Cheo Madera", badgeVisitante: "CM", marcador: "-- - --", cancha: "Cancha Principal" }
  ],
  5: [
    { fecha: "Viernes, 21/08/2026 - 19:00", local: "Team Abrante", badgeLocal: "TA", visitante: "Team Azua", badgeVisitante: "LS", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Viernes, 21/08/2026 - 20:15", local: "Cheo Madera", badgeLocal: "CM", visitante: "A.Q.P", badgeVisitante: "AQE", marcador: "-- - --", cancha: "Cancha Principal" },
    ...
    { fecha: "Sábado, 22/08/2026 - 20:15", local: "Vieja Guardia", badgeLocal: "VG", visitante: "Team Sufrido", badgeVisitante: "TS", marcador: "-- - --", cancha: "Cancha Principal" }
  ],
  6: [
    { fecha: "Viernes, 28/08/2026 - 19:00", local: "Team Sufrido", badgeLocal: "TS", visitante: "Team Abrante", badgeVisitante: "TA", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Viernes, 28/08/2026 - 20:15", local: "Team Azua", badgeLocal: "LS", visitante: "Cheo Madera", badgeVisitante: "CM", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 29/08/2026 - 19:00", local: "A.Q.P", badgeLocal: "AQE", visitante: "Team Bichota", badgeVisitante: "TB", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 29/08/2026 - 20:15", local: "Marqués de Vadillo", badgeLocal: "MV", visitante: "Vieja Guardia", badgeVisitante: "VG", marcador: "-- - --", cancha: "Cancha Principal" }
  ],
  7: [
    { fecha: "Viernes, 04/09/2026 - 19:00", local: "Team Abrante", badgeLocal: "TA", visitante: "Marqués de Vadillo", badgeVisitante: "MV", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Viernes, 04/09/2026 - 20:15", local: "Vieja Guardia", badgeLocal: "VG", visitante: "A.Q.P", badgeVisitante: "AQE", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 05/09/2026 - 19:00", local: "Team Bichota", badgeLocal: "TB", visitante: "Team Azua", badgeVisitante: "LS", marcador: "-- - --", cancha: "Cancha Principal" },
    { fecha: "Sábado, 05/09/2026 - 20:15", local: "Cheo Madera", badgeLocal: "CM", visitante: "Team Sufrido", badgeVisitante: "TS", marcador: "-- - --", cancha: "Cancha Principal" }
  ],
  "semis": [
